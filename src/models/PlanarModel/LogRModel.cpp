#include "FSML/models/LogRModel/LogRModel.h"
    ...
    void LogRModel::train(tables::Table& trainingData, int featuresStart, int featuresEnd, std::string targetColTitle, int epochs) {
    ...
    double LogRModel::getConstant() {
        return constant;
    }
    
    void LogRModel::setConstant(double constant) {
        this->constant = constant;
    }
    
    std::vector<double> LogRModel::getCoeffs() {
        return coeffs;
    }
    
    void LogRModel::setCoeffs(std::vector<double>) {
        this->coeffs = coeffs;
    }
    
    double LogRModel::getLearningRate() {
        return learningRate;
    }

    void LogRModel::setLearningRate(double learningRate) {
